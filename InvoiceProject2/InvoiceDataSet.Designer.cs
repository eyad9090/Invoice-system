...
namespace InvoiceProject2 {
    ...
    public partial class InvoiceDataSet : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationItems_Invoices;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationItems_Invoices = this.Relations["Items_Invoices"];
        }
        ...
        private void InitClass() {
            ...
            this.relationItems_Invoices = new global::System.Data.DataRelation("Items_Invoices", new global::System.Data.DataColumn[] {
                        this.tableItems.InvoiceIdColumn}, new global::System.Data.DataColumn[] {
                        this.tableInvoices.InvoiceIdColumn}, false);
            this.Relations.Add(this.relationItems_Invoices);
        }
        ...
        public partial class InvoicesDataTable : global::System.Data.TypedTableBase<InvoicesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public InvoicesRow AddInvoicesRow(System.DateTime InvoiceDate, bool PaymentMethod, string Customer, string Description) {
        ...
        public partial class ItemsDataTable : global::System.Data.TypedTableBase<ItemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ItemsRow AddItemsRow(int InvoiceId, string ItemName, int Qty, double Price) {
        ...
        public partial class InvoicesRow : global::System.Data.DataRow {
            ...
            public bool PaymentMethod {
                get {
                    return ((bool)(this[this.tableInvoices.PaymentMethodColumn]));
                }
                set {
            ...
            public ItemsRow ItemsRow {
                get {
                    return ((ItemsRow)(this.GetParentRow(this.Table.ParentRelations["Items_Invoices"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["Items_Invoices"]);
                }
            }
        ...
        public partial class ItemsRow : global::System.Data.DataRow {
            ...
            public InvoicesRow[] GetInvoicesRows() {
                if ((this.Table.ChildRelations["Items_Invoices"] == null)) {
                    return new InvoicesRow[0];
                }
                else {
                    return ((InvoicesRow[])(base.GetChildRows(this.Table.ChildRelations["Items_Invoices"])));
                }
            }
        }
...
namespace InvoiceProject2.InvoiceDataSetTableAdapters {
    ...
    public partial class InvoicesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Invoices] ([InvoiceDate], [PaymentMethod], [Customer], [Descri" +
                "ption]) VALUES (@InvoiceDate, @PaymentMethod, @Customer, @Description)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@PaymentMethod", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "PaymentMethod", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Invoices] SET [InvoiceDate] = @InvoiceDate, [PaymentMethod] = @Paym" +
                "entMethod, [Customer] = @Customer, [Description] = @Description WHERE (([Invoice" +
                "Id] = @Original_InvoiceId))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@PaymentMethod", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "PaymentMethod", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT InvoiceId, InvoiceDate, PaymentMethod, Customer, Description FROM dbo.Invo" +
                "ices";
        ...
        public virtual int Insert(System.DateTime InvoiceDate, bool PaymentMethod, string Customer, string Description) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((System.DateTime)(InvoiceDate));
            this.Adapter.InsertCommand.Parameters[1].Value = ((bool)(PaymentMethod));
            if ((Customer == null)) {
        ...
        public virtual int Update(System.DateTime InvoiceDate, bool PaymentMethod, string Customer, string Description, int Original_InvoiceId) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((System.DateTime)(InvoiceDate));
            this.Adapter.UpdateCommand.Parameters[1].Value = ((bool)(PaymentMethod));
            if ((Customer == null)) {
                throw new global::System.ArgumentNullException("Customer");
            }
            else {
    ...
    public partial class ItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Items] WHERE (([ItemCode] = @Original_ItemCode))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Items] ([InvoiceId], [ItemName], [Qty], [Price]) VALUES (@Invo" +
                "iceId, @ItemName, @Qty, @Price)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Items] SET [InvoiceId] = @InvoiceId, [ItemName] = @ItemName, [Qty] " +
                "= @Qty, [Price] = @Price WHERE (([ItemCode] = @Original_ItemCode))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT ItemCode, InvoiceId, ItemName, Qty, Price FROM dbo.Items";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(InvoiceDataSet.ItemsDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual InvoiceDataSet.ItemsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            InvoiceDataSet.ItemsDataTable dataTable = new InvoiceDataSet.ItemsDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(InvoiceDataSet.ItemsDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int InvoiceId, string ItemName, int Qty, double Price) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int InvoiceId, string ItemName, int Qty, double Price, int Original_ItemCode) {
